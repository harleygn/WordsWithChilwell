...
def ExportScore(PlayerName, PlayerOneScore, PlayerTwoScore):
  PlayerScores = {PlayerName[0]:PlayerOneScore , PlayerName[1]: PlayerTwoScore}
  print("Please enter yes or no on whether or not to export your scores from this game")
  Validation = input()
  if Validation == "yes":
    ScoreSheet = open("scoresheet.txt", "w")
    ScoreSheet.write(str((PlayerName[0] , PlayerOneScore)))
    ScoreSheet.write(str((PlayerName[1] , PlayerTwoScore)))
  else:
    print("No exportation of score due to unwanted export or invalid input")
  

def GetPlayerName():
  print()
  print("Please enter a suitable playername")
  try:
    PlayerName = str(input())
  except:
    print("You entered an invalid username, try again")
  print()
  return PlayerName
...
def DisplayWinner(PlayerOneScore, PlayerTwoScore, PlayerName):
  print()
  print("**** GAME OVER! ****")
  print()
  print(PlayerName[0], "your score is", PlayerOneScore)
  print(PlayerName[1], "your score is", PlayerTwoScore)
  if PlayerOneScore > PlayerTwoScore:
    print(PlayerName[0] , "wins!")
  elif PlayerTwoScore > PlayerOneScore:
    print(PlayerName[1] , "wins!")
  else:
    print("It is a draw!")
  print()
  ExportScore(PlayerName, PlayerOneScore, PlayerTwoScore)
  
def PlayGame(AllowedWords, TileDictionary, RandomStart, StartHandSize, MaxHandSize, MaxTilesPlayed, NoOfEndOfTurnTiles, PlayerName):
  PlayerOneScore = 50
  PlayerTwoScore = 50
  ...
  DisplayWinner(PlayerOneScore, PlayerTwoScore, PlayerName)
...
def Main():
  ...
  while Choice != "9":
    ...
    if Choice == "1":
      PlayGame(AllowedWords, TileDictionary, True, StartHandSize, MaxHandSize, MaxTilesPlayed, NoOfEndOfTurnTiles, PlayerName)
    elif Choice == "2":
      PlayGame(AllowedWords, TileDictionary, False, 15, MaxHandSize, MaxTilesPlayed, NoOfEndOfTurnTiles, PlayerName)
